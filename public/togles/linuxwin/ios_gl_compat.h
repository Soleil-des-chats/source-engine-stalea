// Auto-generated by patch_ios_togles.py -- do not hand-edit.
//
// Fallback desktop-GL enum tokens for iOS builds, where Apple's
// OpenGLES/ES2 headers don't define many desktop/ARB/EXT enums that
// this codebase's togles layer still references. GL enum values are
// shared across the GL/GLES registries, so these are safe -- each is
// only defined if not already provided by the real platform headers.
#ifndef IOS_GL_COMPAT_H
#define IOS_GL_COMPAT_H
